...
describe('DataNode', () => {
  ...
  it('should return the correct preorder traversal', () => {
    const expectedTraversal = [rootNode, rootNode.left, rootNode.left?.left, rootNode.left?.right, rootNode.right, rootNode.right?.left, rootNode.right?.right]
  ...
  it('should return the correct inorder traversal', () => {
    const expectedTraversal = [rootNode.left?.left, rootNode.left, rootNode.left?.right, rootNode, rootNode.right?.left, rootNode.right, rootNode.right?.right]
    const actualTraversal = rootNode.getTraversal(ArrowDirection.INORDER)
    expect(actualTraversal).toEqual(expectedTraversal)
  })

  it('should return the correct postorder traversal', () => {
    const expectedTraversal = [rootNode.left?.left, rootNode.left?.right, rootNode.left, rootNode.right?.left, rootNode.right?.right, rootNode.right, rootNode]
